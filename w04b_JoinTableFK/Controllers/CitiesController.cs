...
namespace CodeFirstStuff.Controllers
{
    public class CitiesController : Controller
    {
        ...
        {
            var cities = db.Cities.Include(p => p.Province);
        ...
        {
            ViewBag.ProvinceCode = new SelectList(db.Provinces, "ProvinceCode");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "CityId, CityName, Papulation, ProvinceCode")] City city)
        {
            ...
            ViewBag.ProvinceCode = new SelectList(db.Provinces, "ProvinceCode", city.ProvinceCode);
            return View(city);
        }
