...
namespace CodeFirstStuff.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "JerseyNumber,FirstName,LastName,Position,IsRight,Salary,StartDate,TeamName")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "JerseyNumber,FirstName,LastName,Position,IsRight,Salary,StartDate,TeamName")] Player player)
        {
            if (ModelState.IsValid)
            {
